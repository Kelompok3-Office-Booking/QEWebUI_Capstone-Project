...
//WebUI.click(findTestObject('Object Repository/Logout/Page_Better Space/div_Login SuccessOKNoCancel'))

WebUI.click(findTestObject('Object Repository/Logout/Page_Better Space/button_Admin Slot'))
...
//WebUI.click(findTestObject('Object Repository/Logout/Page_Better Space/div_LogoutLogout SuccessOKNoCancel'))

//WebUI.click(findTestObject('Object Repository/Logout/Page_Better Space/button_OK'))
