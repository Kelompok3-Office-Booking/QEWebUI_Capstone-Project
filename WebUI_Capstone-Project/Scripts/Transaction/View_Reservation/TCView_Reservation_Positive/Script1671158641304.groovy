...
WebUI.click(findTestObject('Object Repository/Transaction/View_Reservation/Page_Dashboard/div_Transaction'))

WebUI.click(findTestObject('Object Repository/Transaction/View_Reservation/Page_Dashboard  Transactions/h1_(49) Record Found'))

WebUI.click(findTestObject('Object Repository/Transaction/View_Reservation/Page_Dashboard  Transactions/td_Deer'))

WebUI.click(findTestObject('Object Repository/Transaction/View_Reservation/Page_Dashboard  Transactions/td_Selena 12'))
