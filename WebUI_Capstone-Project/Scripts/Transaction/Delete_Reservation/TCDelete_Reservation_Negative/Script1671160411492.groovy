...
WebUI.click(findTestObject('Object Repository/Transaction/delete/Page_Dashboard  Transactions/svg_Pending_MuiSvgIcon-root MuiSvgIcon-font_6a796f'))

WebUI.click(findTestObject('Object Repository/Transaction/delete/Page_Dashboard  Transactions/h2_Are you sure'))

WebUI.click(findTestObject('Object Repository/Transaction/delete/Page_Dashboard  Transactions/button_No, cancel'))
