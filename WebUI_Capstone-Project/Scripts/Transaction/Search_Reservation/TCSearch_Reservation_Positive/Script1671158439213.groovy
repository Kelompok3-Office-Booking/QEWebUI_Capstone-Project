...
WebUI.click(findTestObject('Object Repository/Transaction/Search_Reservation/Page_Dashboard/div_Transaction'))

WebUI.setText(findTestObject('Object Repository/Transaction/Search_Reservation/Page_Dashboard  Transactions/input_Search_table-search-users'), 
    'selena')

WebUI.click(findTestObject('Object Repository/Transaction/Search_Reservation/Page_Dashboard  Transactions/td_Selena 12'))

WebUI.click(findTestObject('Object Repository/Transaction/Search_Reservation/Page_Dashboard  Transactions/td_Selena 14'))
