...
WebUI.click(findTestObject('Object Repository/Offices/Delete_Offices/Page_Dashboard  Offices/button_Coworking Space_px-2 py-2 font-mediu_dc2494'))

WebUI.click(findTestObject('Object Repository/Offices/Delete_Offices/Page_Dashboard  Offices/div_Are you sureThe selected record will be_cb9ce0'))

WebUI.click(findTestObject('Object Repository/Offices/Delete_Offices/Page_Dashboard  Offices/button_No, cancel'))
